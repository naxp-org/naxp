...
The current status of **naxp** is *experimental* at **version 0.10**. From version 1 the encoding will be stable: the values a **naxp** produces will not change between versions.
